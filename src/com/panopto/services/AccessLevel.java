...
public class AccessLevel implements java.io.Serializable {
    ...
    public static final AccessLevel Error = new AccessLevel(_Error);
    public static final AccessLevel Creator = new AccessLevel(_Creator);
    public static final AccessLevel Viewer = new AccessLevel(_Viewer);
    public static final AccessLevel Public = new AccessLevel(_Public);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://services.panopto.com", "AccessLevel"));
    }
    /**
